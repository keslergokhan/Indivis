...
namespace Indivis.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241021220929_LocalizationUpdateColmnRemove")]
    partial class LocalizationUpdateColmnRemove
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Indivis.Core.Domain.Entities.CoreEntities.Localization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<bool>("IsBackendLocalization")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("IsPageLocalization")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Indivis.Core.Domain.Entities.CoreEntities.LocalizationRegion", b =>
                {
                    ...
                    b.ToTable("LocalizationRegion", (string)null);
                });
            ...
            modelBuilder.Entity("Indivis.Core.Domain.Entities.CoreEntities.LocalizationRegion", b =>
                {
                    ...
                    b.HasOne("Indivis.Core.Domain.Entities.CoreEntities.Localization", "Localization")
                        .WithMany("Region")
